...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansDevicePlan.findAll", query = "SELECT p FROM PlansDevicePlan p")
    , @NamedQuery(name = "PlansDevicePlan.findById", query = "SELECT p FROM PlansDevicePlan p WHERE p.id = :id")
    , @NamedQuery(name = "PlansDevicePlan.findByIsActive", query = "SELECT p FROM PlansDevicePlan p WHERE p.isActive = :isActive")
    , @NamedQuery(name = "PlansDevicePlan.findByCreationDatetime", query = "SELECT p FROM PlansDevicePlan p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansDevicePlan.findByLastModifiedDatetime", query = "SELECT p FROM PlansDevicePlan p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansDevicePlan.findByWifiPlan", query = "SELECT p FROM PlansDevicePlan p WHERE p.wifiPlan = :wifiPlan")
    , @NamedQuery(name = "PlansDevicePlan.findBySocialData", query = "SELECT p FROM PlansDevicePlan p WHERE p.socialData = :socialData")
    , @NamedQuery(name = "PlansDevicePlan.findByDataBundel", query = "SELECT p FROM PlansDevicePlan p WHERE p.dataBundel = :dataBundel")
    , @NamedQuery(name = "PlansDevicePlan.findByFlexiDetails", query = "SELECT p FROM PlansDevicePlan p WHERE p.flexiDetails = :flexiDetails")
    , @NamedQuery(name = "PlansDevicePlan.findByPlanOutofBundel", query = "SELECT p FROM PlansDevicePlan p WHERE p.planOutofBundel = :planOutofBundel")
    , @NamedQuery(name = "PlansDevicePlan.findByNationalMin", query = "SELECT p FROM PlansDevicePlan p WHERE p.nationalMin = :nationalMin")
    , @NamedQuery(name = "PlansDevicePlan.findByRoamingIncomingMin", query = "SELECT p FROM PlansDevicePlan p WHERE p.roamingIncomingMin = :roamingIncomingMin")
    , @NamedQuery(name = "PlansDevicePlan.findByNationalMinOffnet", query = "SELECT p FROM PlansDevicePlan p WHERE p.nationalMinOffnet = :nationalMinOffnet")
    , @NamedQuery(name = "PlansDevicePlan.findByPlanPreffNumber", query = "SELECT p FROM PlansDevicePlan p WHERE p.planPreffNumber = :planPreffNumber")
    , @NamedQuery(name = "PlansDevicePlan.findByInternationalSms", query = "SELECT p FROM PlansDevicePlan p WHERE p.internationalSms = :internationalSms")
    , @NamedQuery(name = "PlansDevicePlan.findByPlanFee", query = "SELECT p FROM PlansDevicePlan p WHERE p.planFee = :planFee")
    , @NamedQuery(name = "PlansDevicePlan.findByMisFeatures", query = "SELECT p FROM PlansDevicePlan p WHERE p.misFeatures = :misFeatures")
    , @NamedQuery(name = "PlansDevicePlan.findByPlanId", query = "SELECT p FROM PlansDevicePlan p WHERE p.planId = :planId")
    , @NamedQuery(name = "PlansDevicePlan.findByPlanUrl", query = "SELECT p FROM PlansDevicePlan p WHERE p.planUrl = :planUrl")
    , @NamedQuery(name = "PlansDevicePlan.findByPlanRefid", query = "SELECT p FROM PlansDevicePlan p WHERE p.planRefid = :planRefid")})
