...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansPlanflexiEntity.findAll", query = "SELECT p FROM PlansPlanflexiEntity p")
    , @NamedQuery(name = "PlansPlanflexiEntity.findById", query = "SELECT p FROM PlansPlanflexiEntity p WHERE p.id = :id")
    , @NamedQuery(name = "PlansPlanflexiEntity.findByFlexiMinutes", query = "SELECT p FROM PlansPlanflexiEntity p WHERE p.flexiMinutes = :flexiMinutes")
    , @NamedQuery(name = "PlansPlanflexiEntity.findByFlexiMinutesPulse", query = "SELECT p FROM PlansPlanflexiEntity p WHERE p.flexiMinutesPulse = :flexiMinutesPulse")
    , @NamedQuery(name = "PlansPlanflexiEntity.findByFlexiMinutesRollover", query = "SELECT p FROM PlansPlanflexiEntity p WHERE p.flexiMinutesRollover = :flexiMinutesRollover")
    , @NamedQuery(name = "PlansPlanflexiEntity.findByCreationDatetime", query = "SELECT p FROM PlansPlanflexiEntity p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansPlanflexiEntity.findByLastModifiedDatetime", query = "SELECT p FROM PlansPlanflexiEntity p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansPlanflexiEntity.findByIsActive", query = "SELECT p FROM PlansPlanflexiEntity p WHERE p.isActive = :isActive")})
public class PlansPlanflexiEntity implements Serializable {
    ...
    public PlansPlanflexiEntity() {
    }

    public PlansPlanflexiEntity(Integer id) {
        this.id = id;
    }

    public PlansPlanflexiEntity(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanflexiEntity)) {
            return false;
        }
        PlansPlanflexiEntity other = (PlansPlanflexiEntity) object;
