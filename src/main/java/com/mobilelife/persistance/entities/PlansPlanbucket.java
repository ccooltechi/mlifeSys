...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansPlanbucket.findAll", query = "SELECT p FROM PlansPlanbucket p")
    , @NamedQuery(name = "PlansPlanbucket.findById", query = "SELECT p FROM PlansPlanbucket p WHERE p.id = :id")
    , @NamedQuery(name = "PlansPlanbucket.findByGroup", query = "SELECT p FROM PlansPlanbucket p WHERE p.planGroup = :planGroup")
    , @NamedQuery(name = "PlansPlanbucket.findByBucket", query = "SELECT p FROM PlansPlanbucket p WHERE p.bucket = :bucket")
    , @NamedQuery(name = "PlansPlanbucket.findByForeignOperator", query = "SELECT p FROM PlansPlanbucket p WHERE p.foreignOperator = :foreignOperator")
    , @NamedQuery(name = "PlansPlanbucket.findByCountryInBundle", query = "SELECT p FROM PlansPlanbucket p WHERE p.countryInBundle = :countryInBundle")
    , @NamedQuery(name = "PlansPlanbucket.findByOobRate", query = "SELECT p FROM PlansPlanbucket p WHERE p.oobRate = :oobRate")
    , @NamedQuery(name = "PlansPlanbucket.findByCalIntrabundleRate", query = "SELECT p FROM PlansPlanbucket p WHERE p.calIntrabundleRate = :calIntrabundleRate")
    , @NamedQuery(name = "PlansPlanbucket.findByMinPluse", query = "SELECT p FROM PlansPlanbucket p WHERE p.minPluse = :minPluse")
    , @NamedQuery(name = "PlansPlanbucket.findByLebel", query = "SELECT p FROM PlansPlanbucket p WHERE p.label = :label")
    , @NamedQuery(name = "PlansPlanbucket.findByCreationDatetime", query = "SELECT p FROM PlansPlanbucket p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansPlanbucket.findByLastModifiedDatetime", query = "SELECT p FROM PlansPlanbucket p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansPlanbucket.findByIsActive", query = "SELECT p FROM PlansPlanbucket p WHERE p.isActive = :isActive")})
