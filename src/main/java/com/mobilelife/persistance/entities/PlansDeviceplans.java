...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansDeviceplans.findAll", query = "SELECT p FROM PlansDeviceplans p")
    , @NamedQuery(name = "PlansDeviceplans.findById", query = "SELECT p FROM PlansDeviceplans p WHERE p.id = :id")
    , @NamedQuery(name = "PlansDeviceplans.findByPlanPrimaryId", query = "SELECT p FROM PlansDeviceplans p WHERE p.planPrimaryId = :planPrimaryId")
    , @NamedQuery(name = "PlansDeviceplans.findByCost", query = "SELECT p FROM PlansDeviceplans p WHERE p.cost = :cost")
    , @NamedQuery(name = "PlansDeviceplans.findByIsActive", query = "SELECT p FROM PlansDeviceplans p WHERE p.isActive = :isActive")
    , @NamedQuery(name = "PlansDeviceplans.findByCreationDatetime", query = "SELECT p FROM PlansDeviceplans p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansDeviceplans.findByLastModifiedDatetime", query = "SELECT p FROM PlansDeviceplans p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")})
