...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansPartnerRoute.findAll", query = "SELECT p FROM PlansPartnerRouteEntity p")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findById", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.id = :id")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findByRetailstore", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.retailstore = :retailstore")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findByCallback", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.callback = :callback")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findByTelcoredirect", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.telcoredirect = :telcoredirect")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findByAffiliate", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.affiliate = :affiliate")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findByCreationDatetime", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findByLastModifiedDatetime", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansPartnerRouteEntity.findByIsActive", query = "SELECT p FROM PlansPartnerRouteEntity p WHERE p.isActive = :isActive")})
public class PlansPartnerRouteEntity implements Serializable {
    ...
    public PlansPartnerRouteEntity() {
    }

    public PlansPartnerRouteEntity(Integer id) {
        this.id = id;
    }

    public PlansPartnerRouteEntity(Integer id, boolean retailstore, boolean callback, boolean telcoredirect, boolean affiliate, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPartnerRouteEntity)) {
            return false;
        }
        PlansPartnerRouteEntity other = (PlansPartnerRouteEntity) object;
