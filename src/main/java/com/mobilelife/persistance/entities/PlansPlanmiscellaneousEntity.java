...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansPlanmiscellaneousEntity.findAll", query = "SELECT p FROM PlansPlanmiscellaneousEntity p")
    , @NamedQuery(name = "PlansPlanmiscellaneousEntity.findById", query = "SELECT p FROM PlansPlanmiscellaneousEntity p WHERE p.id = :id")
    , @NamedQuery(name = "PlansPlanmiscellaneousEntity.findByCreationDatetime", query = "SELECT p FROM PlansPlanmiscellaneousEntity p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansPlanmiscellaneousEntity.findByLastModifiedDatetime", query = "SELECT p FROM PlansPlanmiscellaneousEntity p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansPlanmiscellaneousEntity.findByIsActive", query = "SELECT p FROM PlansPlanmiscellaneousEntity p WHERE p.isActive = :isActive")})
public class PlansPlanmiscellaneousEntity implements Serializable {
    ...
    public PlansPlanmiscellaneousEntity() {
    }

    public PlansPlanmiscellaneousEntity(Integer id) {
        this.id = id;
    }

    public PlansPlanmiscellaneousEntity(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanmiscellaneousEntity)) {
            return false;
        }
        PlansPlanmiscellaneousEntity other = (PlansPlanmiscellaneousEntity) object;
