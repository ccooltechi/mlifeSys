...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansPlanaddonsEntity.findAll", query = "SELECT p FROM PlansPlanaddonsEntity p")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findById", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.id = :id")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByOperatorId", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.operatorId = :operatorId")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByValidityCount", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.validityCount = :validityCount")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByAllowance", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.allowance = :allowance")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByPrice", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.price = :price")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByRatePerUnit", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.ratePerUnit = :ratePerUnit")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByCreationDatetime", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByLastModifiedDatetime", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansPlanaddonsEntity.findByIsActive", query = "SELECT p FROM PlansPlanaddonsEntity p WHERE p.isActive = :isActive")})
public class PlansPlanaddonsEntity implements Serializable {
    ...
    public PlansPlanaddonsEntity() {
    }

    public PlansPlanaddonsEntity(Integer id) {
        this.id = id;
    }

    public PlansPlanaddonsEntity(Integer id, int operatorId, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanaddonsEntity)) {
            return false;
        }
        PlansPlanaddonsEntity other = (PlansPlanaddonsEntity) object;
