...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansPlanlocalmms.findAll", query = "SELECT p FROM PlansPlanlocalmms p")
    , @NamedQuery(name = "PlansPlanlocalmms.findById", query = "SELECT p FROM PlansPlanlocalmms p WHERE p.id = :id")
    , @NamedQuery(name = "PlansPlanlocalmms.findByLocalMms", query = "SELECT p FROM PlansPlanlocalmms p WHERE p.localMms = :localMms")
    , @NamedQuery(name = "PlansPlanlocalmms.findByLocalMmsUnitrate", query = "SELECT p FROM PlansPlanlocalmms p WHERE p.localMmsUnitrate = :localMmsUnitrate")
    , @NamedQuery(name = "PlansPlanlocalmms.findByCreationDatetime", query = "SELECT p FROM PlansPlanlocalmms p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansPlanlocalmms.findByLastModifiedDatetime", query = "SELECT p FROM PlansPlanlocalmms p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansPlanlocalmms.findByIsActive", query = "SELECT p FROM PlansPlanlocalmms p WHERE p.isActive = :isActive")})
