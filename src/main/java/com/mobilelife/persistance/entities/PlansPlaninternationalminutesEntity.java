...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "PlansPlaninternationalminutesEntity.findAll", query = "SELECT p FROM PlansPlaninternationalminutesEntity p")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findById", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.id = :id")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findByInternationalMinutes", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.internationalMinutes = :internationalMinutes")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findByInternationalMinutePulse", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.internationalMinutePulse = :internationalMinutePulse")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findByInternationalMinutesRollover", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.internationalMinutesRollover = :internationalMinutesRollover")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findByInternationalMinBucketcode", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.internationalMinBucketcode = :internationalMinBucketcode")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findByCreationDatetime", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.creationDatetime = :creationDatetime")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findByLastModifiedDatetime", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.lastModifiedDatetime = :lastModifiedDatetime")
    , @NamedQuery(name = "PlansPlaninternationalminutesEntity.findByIsActive", query = "SELECT p FROM PlansPlaninternationalminutesEntity p WHERE p.isActive = :isActive")})
public class PlansPlaninternationalminutesEntity implements Serializable {
    ...
    public PlansPlaninternationalminutesEntity() {
    }

    public PlansPlaninternationalminutesEntity(Integer id) {
        this.id = id;
    }

    public PlansPlaninternationalminutesEntity(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlaninternationalminutesEntity)) {
            return false;
        }
        PlansPlaninternationalminutesEntity other = (PlansPlaninternationalminutesEntity) object;
