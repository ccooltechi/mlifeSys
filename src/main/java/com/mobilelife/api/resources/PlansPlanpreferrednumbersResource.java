...
public class PlansPlanpreferrednumbersResource {
	private static Logger logger = LoggerFactory.getLogger(PlansPlanpreferrednumbersResource.class);

    PlansPlanpreferrednumbersServices service = new PlansPlanpreferrednumbersServices();
