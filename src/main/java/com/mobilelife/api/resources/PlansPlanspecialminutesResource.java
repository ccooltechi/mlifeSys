...
public class PlansPlanspecialminutesResource {
	private static Logger logger = LoggerFactory.getLogger(PlansPlanspecialminutesResource.class);
	
    PlansPlanspecialminutesServices service = new PlansPlanspecialminutesServices();
