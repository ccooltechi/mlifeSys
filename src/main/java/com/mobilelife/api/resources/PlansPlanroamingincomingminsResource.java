...
public class PlansPlanroamingincomingminsResource {
    ...
    public Response createNew(PlansPlanroamingincomingminsRequest request) {
        PlansPlanroamingincomingminsBean bean = (PlansPlanroamingincomingminsBean)request.getRequest();
        boolean status = service.createOrUpdate(bean);
        PlansPlanroamingincomingminsBean country = service.getByPlanId(bean.getPlanPrimaryId());
    ...
    public Response getById(@PathParam("id") Integer id) {
        PlansPlanroamingincomingminsBean bean  = service.getByPlanId(id);
