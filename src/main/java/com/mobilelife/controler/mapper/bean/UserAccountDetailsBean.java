...
public class UserAccountDetailsBean implements Serializable {
    ...
    private UserAccountBean id;

    public UserAccountDetailsBean() {
    }

    public UserAccountDetailsBean(Integer subId) {
        this.subId = subId;
    }

    public UserAccountDetailsBean(Integer subId, Date creationDatetime, boolean isActive) {
        this.subId = subId;
    ...
    public UserAccountBean getId() {
        return id;
    }

    public void setId(UserAccountBean id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserAccountDetailsBean)) {
            return false;
        }
        UserAccountDetailsBean other = (UserAccountDetailsBean) object;
