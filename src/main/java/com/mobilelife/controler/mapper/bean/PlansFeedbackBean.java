...
public class PlansFeedbackBean implements Serializable {
    ...
    public PlansFeedbackBean() {
    }

    public PlansFeedbackBean(Integer id) {
        this.id = id;
    }

    public PlansFeedbackBean(Integer id, int userId, Date creationDatetime, boolean isActive) {
        this.id = id;
        this.userId = userId;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansFeedbackBean)) {
            return false;
        }
        PlansFeedbackBean other = (PlansFeedbackBean) object;
