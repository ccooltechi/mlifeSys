...
public class PartnerRouteChildBean implements Serializable {
    ...
    public PartnerRouteChildBean() {
    }

    public PartnerRouteChildBean(Integer id) {
        this.id = id;
    }

    public PartnerRouteChildBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
