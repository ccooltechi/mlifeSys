...
public class OrderPlanprimaryBean implements Serializable {
    ...
    public OrderPlanprimaryBean() {
    }

    public OrderPlanprimaryBean(Integer id) {
        this.id = id;
    }

    public OrderPlanprimaryBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
