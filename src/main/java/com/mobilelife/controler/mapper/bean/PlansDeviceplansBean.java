...
public class PlansDeviceplansBean implements Serializable {
    ...
    public PlansDeviceplansBean() {
    }

    public PlansDeviceplansBean(Integer id) {
        this.id = id;
    }

    public PlansDeviceplansBean(Integer id, int planPrimaryId, int cost, boolean isActive, Date creationDatetime) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansDeviceplansBean)) {
            return false;
        }
        PlansDeviceplansBean other = (PlansDeviceplansBean) object;
