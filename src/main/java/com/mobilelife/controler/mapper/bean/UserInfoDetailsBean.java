...
public class UserInfoDetailsBean implements Serializable {
    ...
    private UserInfoBean id;

    public UserInfoDetailsBean() {
    }

    public UserInfoDetailsBean(Integer subId) {
        this.subId = subId;
    }

    public UserInfoDetailsBean(Integer subId, Date creationDatetime, boolean isActive) {
        this.subId = subId;
    ...
    public UserInfoBean getId() {
        return id;
    }

    public void setId(UserInfoBean id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UserInfoDetailsBean)) {
            return false;
        }
        UserInfoDetailsBean other = (UserInfoDetailsBean) object;
