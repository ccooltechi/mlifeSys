...
public class PlansDevicePlanBean implements Serializable {
    ...
    public PlansDevicePlanBean() {
    }

    public PlansDevicePlanBean(Integer id) {
        this.id = id;
    }

    public PlansDevicePlanBean(Integer id, boolean isActive, Date creationDatetime) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansDevicePlanBean)) {
            return false;
        }
        PlansDevicePlanBean other = (PlansDevicePlanBean) object;
