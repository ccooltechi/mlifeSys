...
public class PlansPlanflexiBean implements Serializable {
    ...
    public PlansPlanflexiBean() {
    }

    public PlansPlanflexiBean(Integer id) {
        this.id = id;
    }

    public PlansPlanflexiBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
