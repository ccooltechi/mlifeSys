...
public class PlansPlanflexismsBean implements Serializable {
    ...
    public PlansPlanflexismsBean() {
    }

    public PlansPlanflexismsBean(Integer id) {
        this.id = id;
    }

    public PlansPlanflexismsBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanflexismsBean)) {
            return false;
        }
        PlansPlanflexismsBean other = (PlansPlanflexismsBean) object;
