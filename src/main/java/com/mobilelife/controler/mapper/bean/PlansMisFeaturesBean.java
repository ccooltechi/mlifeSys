...
public class PlansMisFeaturesBean implements Serializable {
...
//    private int plan_primary_id;
    ...
    public PlansMisFeaturesBean() {
    }

    public PlansMisFeaturesBean(Integer id) {
        this.id = id;
    }

    public PlansMisFeaturesBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
...
//	}
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansMisFeaturesBean)) {
            return false;
        }
        PlansMisFeaturesBean other = (PlansMisFeaturesBean) object;
