...
public class PlansPlannationaldataBean implements Serializable {
    ...
    public PlansPlannationaldataBean() {
    }

    public PlansPlannationaldataBean(Integer id) {
        this.id = id;
    }

    public PlansPlannationaldataBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlannationaldataBean)) {
            return false;
        }
        PlansPlannationaldataBean other = (PlansPlannationaldataBean) object;
