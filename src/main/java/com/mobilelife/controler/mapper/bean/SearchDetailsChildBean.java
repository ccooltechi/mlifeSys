...
public class SearchDetailsChildBean implements Serializable {
    ...
    private SearchDetailsBean searchId;
    @Column(name = "token")
    private String token;
    @Column(name = "plan_reponse")
    private String planReponse;

    public SearchDetailsChildBean() {
    }

    public SearchDetailsChildBean(Integer id) {
        this.id = id;
    }

    public SearchDetailsChildBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public SearchDetailsBean getSearchId() {
        return searchId;
    }

    public void setSearchId(SearchDetailsBean searchId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SearchDetailsChildBean)) {
            return false;
        }
        SearchDetailsChildBean other = (SearchDetailsChildBean) object;
