...
public class PlansPlansmsBean implements Serializable {
    ...
    public PlansPlansmsBean() {
    }

    public PlansPlansmsBean(Integer id) {
        this.id = id;
    }

    public PlansPlansmsBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlansmsBean)) {
            return false;
        }
        PlansPlansmsBean other = (PlansPlansmsBean) object;
