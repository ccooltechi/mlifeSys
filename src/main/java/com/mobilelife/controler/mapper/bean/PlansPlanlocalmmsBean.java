...
public class PlansPlanlocalmmsBean implements Serializable {
    ...
    public PlansPlanlocalmmsBean() {
    }

    public PlansPlanlocalmmsBean(Integer id) {
        this.id = id;
    }

    public PlansPlanlocalmmsBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanlocalmmsBean)) {
            return false;
        }
        PlansPlanlocalmmsBean other = (PlansPlanlocalmmsBean) object;
