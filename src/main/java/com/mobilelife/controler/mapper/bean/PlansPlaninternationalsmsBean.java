...
public class PlansPlaninternationalsmsBean implements Serializable {
    ...
    public PlansPlaninternationalsmsBean() {
    }

    public PlansPlaninternationalsmsBean(Integer id) {
        this.id = id;
    }

    public PlansPlaninternationalsmsBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlaninternationalsmsBean)) {
            return false;
        }
        PlansPlaninternationalsmsBean other = (PlansPlaninternationalsmsBean) object;
