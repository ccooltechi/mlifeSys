...
public class PlansPlanbucketBean implements Serializable {
    ...
    @ManyToOne
    private CountriesBean countryId;
    ...
    public PlansPlanbucketBean() {
    }

    public PlansPlanbucketBean(Integer id) {
        this.id = id;
    }

    public PlansPlanbucketBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public CountriesBean getCountryId() {
        return countryId;
    }

    public void setCountryId(CountriesBean countryId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanbucketBean)) {
            return false;
        }
        PlansPlanbucketBean other = (PlansPlanbucketBean) object;
