...
public class PlanDevicecolorBean implements Serializable {
    ...
    public PlanDevicecolorBean() {
    }

    public PlanDevicecolorBean(Integer id) {
        this.id = id;
    }

    public PlanDevicecolorBean(Integer id, boolean isActive, Date creationDatetime) {
        this.id = id;
