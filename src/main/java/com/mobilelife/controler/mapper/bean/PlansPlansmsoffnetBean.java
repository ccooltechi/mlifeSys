...
public class PlansPlansmsoffnetBean implements Serializable {
    ...
    public PlansPlansmsoffnetBean() {
    }

    public PlansPlansmsoffnetBean(Integer id) {
        this.id = id;
    }

    public PlansPlansmsoffnetBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlansmsoffnetBean)) {
            return false;
        }
        PlansPlansmsoffnetBean other = (PlansPlansmsoffnetBean) object;
