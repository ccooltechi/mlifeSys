...
public class PlansPlanroamingoutgoingminsBean implements Serializable {
    ...
    public PlansPlanroamingoutgoingminsBean() {
    }

    public PlansPlanroamingoutgoingminsBean(Integer id) {
        this.id = id;
    }

    public PlansPlanroamingoutgoingminsBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanroamingoutgoingminsBean)) {
            return false;
        }
        PlansPlanroamingoutgoingminsBean other = (PlansPlanroamingoutgoingminsBean) object;
