...
public class PlansPlanwifiBean implements Serializable {
    ...
    public PlansPlanwifiBean() {
    }

    public PlansPlanwifiBean(Integer id) {
        this.id = id;
    }

    public PlansPlanwifiBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanwifiBean)) {
            return false;
        }
        PlansPlanwifiBean other = (PlansPlanwifiBean) object;
