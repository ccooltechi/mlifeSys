...
public class PlansPlanpreferrednumbersBean implements Serializable {
    ...
    public PlansPlanpreferrednumbersBean() {
    }

    public PlansPlanpreferrednumbersBean(Integer id) {
        this.id = id;
    }

    public PlansPlanpreferrednumbersBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanpreferrednumbersBean)) {
            return false;
        }
        PlansPlanpreferrednumbersBean other = (PlansPlanpreferrednumbersBean) object;
