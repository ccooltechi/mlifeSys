...
public class PlansPlansmsonnetBean implements Serializable {
    ...
    public PlansPlansmsonnetBean() {
    }

    public PlansPlansmsonnetBean(Integer id) {
        this.id = id;
    }

    public PlansPlansmsonnetBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlansmsonnetBean)) {
            return false;
        }
        PlansPlansmsonnetBean other = (PlansPlansmsonnetBean) object;
