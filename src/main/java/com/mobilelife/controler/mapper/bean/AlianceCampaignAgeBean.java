...
public class AlianceCampaignAgeBean implements Serializable {
    ...
    public AlianceCampaignAgeBean() {
    }

    public AlianceCampaignAgeBean(Integer id) {
        this.id = id;
    }

    public AlianceCampaignAgeBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
