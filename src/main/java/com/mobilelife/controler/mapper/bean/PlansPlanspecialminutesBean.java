...
public class PlansPlanspecialminutesBean implements Serializable {
    ...
    public PlansPlanspecialminutesBean() {
    }

    public PlansPlanspecialminutesBean(Integer id) {
        this.id = id;
    }

    public PlansPlanspecialminutesBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanspecialminutesBean)) {
            return false;
        }
        PlansPlanspecialminutesBean other = (PlansPlanspecialminutesBean) object;
