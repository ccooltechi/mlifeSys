...
public class PlansPlanaddonsBean implements Serializable {
    ...
    public PlansPlanaddonsBean() {
    }

    public PlansPlanaddonsBean(Integer id) {
        this.id = id;
    }

    public PlansPlanaddonsBean(Integer id, int operatorId, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanaddonsBean)) {
            return false;
        }
        PlansPlanaddonsBean other = (PlansPlanaddonsBean) object;
