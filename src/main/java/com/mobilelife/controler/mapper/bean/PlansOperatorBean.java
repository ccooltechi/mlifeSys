...
@ApiModel("request")
public class PlansOperatorBean implements Serializable {
    ...
    public PlansOperatorBean() {
    }

    public PlansOperatorBean(Integer id) {
        this.id = id;
    }

    public PlansOperatorBean(Integer id, String operatorName, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansOperatorBean)) {
            return false;
        }
        PlansOperatorBean other = (PlansOperatorBean) object;
