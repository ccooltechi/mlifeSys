...
public class PlansPlaninternationalcallsmsBean implements Serializable {
    ...
    public PlansPlaninternationalcallsmsBean() {
    }

    public PlansPlaninternationalcallsmsBean(Integer id) {
        this.id = id;
    }

    public PlansPlaninternationalcallsmsBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlaninternationalcallsmsBean)) {
            return false;
        }
        PlansPlaninternationalcallsmsBean other = (PlansPlaninternationalcallsmsBean) object;
