...
public class PlansPlansocialdataBean implements Serializable {
    ...
    public PlansPlansocialdataBean() {
    }

    public PlansPlansocialdataBean(Integer id) {
        this.id = id;
    }

    public PlansPlansocialdataBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlansocialdataBean)) {
            return false;
        }
        PlansPlansocialdataBean other = (PlansPlansocialdataBean) object;
