...
public class PlansPlanunitsBean implements Serializable {
    ...
    public PlansPlanunitsBean() {
    }

    public PlansPlanunitsBean(Integer id) {
        this.id = id;
    }

    public PlansPlanunitsBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanunitsBean)) {
            return false;
        }
        PlansPlanunitsBean other = (PlansPlanunitsBean) object;
