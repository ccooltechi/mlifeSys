...
public class PartnerRouteArchiveBean implements Serializable {
    ...
    public PartnerRouteArchiveBean() {
    }

    public PartnerRouteArchiveBean(Integer id) {
        this.id = id;
    }

    public PartnerRouteArchiveBean(Integer id, Date creationDatetime) {
        this.id = id;
