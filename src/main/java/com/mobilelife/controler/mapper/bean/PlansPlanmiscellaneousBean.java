...
public class PlansPlanmiscellaneousBean implements Serializable {
    ...
    public PlansPlanmiscellaneousBean() {
    }

    public PlansPlanmiscellaneousBean(Integer id) {
        this.id = id;
    }

    public PlansPlanmiscellaneousBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlanmiscellaneousBean)) {
            return false;
        }
        PlansPlanmiscellaneousBean other = (PlansPlanmiscellaneousBean) object;
