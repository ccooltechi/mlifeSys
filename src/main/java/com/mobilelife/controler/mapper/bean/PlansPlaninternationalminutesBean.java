...
public class PlansPlaninternationalminutesBean implements Serializable {
    ...
    public PlansPlaninternationalminutesBean() {
    }

    public PlansPlaninternationalminutesBean(Integer id) {
        this.id = id;
    }

    public PlansPlaninternationalminutesBean(Integer id, Date creationDatetime, boolean isActive) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PlansPlaninternationalminutesBean)) {
            return false;
        }
        PlansPlaninternationalminutesBean other = (PlansPlaninternationalminutesBean) object;
