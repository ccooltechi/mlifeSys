...
@ApiModel("filters")
public class PlansPlanlocalmmsRequest {
    @XmlAttribute
    ...
    @XmlElement
	private PlansPlanlocalmmsBean request;
	...
	public PlansPlanlocalmmsBean getRequest() {
		return request;
	}
	public void setRequest(PlansPlanlocalmmsBean request) {
