...
@ApiModel("filters")
public class PlansPlanroamingdataRequest {
    @XmlAttribute
    ...
    @XmlElement
	private PlansPlanroamingdataBean request;
	...
	public PlansPlanroamingdataBean getRequest() {
		return request;
	}
	public void setRequest(PlansPlanroamingdataBean request) {
