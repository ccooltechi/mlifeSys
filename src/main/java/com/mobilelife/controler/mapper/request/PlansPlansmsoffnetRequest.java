...
@ApiModel("filters")
public class PlansPlansmsoffnetRequest {
    @XmlAttribute
    ...
    @XmlElement
	private PlansPlansmsoffnetBean request;
	...
	public PlansPlansmsoffnetBean getRequest() {
		return request;
	}
	public void setRequest(PlansPlansmsoffnetBean request) {
