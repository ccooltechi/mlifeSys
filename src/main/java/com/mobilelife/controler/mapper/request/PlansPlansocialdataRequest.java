...
@ApiModel("filters")
public class PlansPlansocialdataRequest {
    @XmlAttribute
    ...
    @XmlElement
	private PlansPlansocialdataBean request;
	...
	public PlansPlansocialdataBean getRequest() {
		return request;
	}
	public void setRequest(PlansPlansocialdataBean request) {
