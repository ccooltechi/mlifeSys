...
@ApiModel("filters")
public class PlansPlanbucketRequest {
    @XmlAttribute
    ...
    @XmlElement
	private PlansPlanbucketBean request;
	...
	public PlansPlanbucketBean getRequest() {
		return request;
	}
	public void setRequest(PlansPlanbucketBean request) {
