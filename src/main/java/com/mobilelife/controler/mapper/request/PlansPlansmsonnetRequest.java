...
@ApiModel("filters")
public class PlansPlansmsonnetRequest {
    @XmlAttribute
    ...
    @XmlElement
	private PlansPlansmsonnetBean request;
	...
	public PlansPlansmsonnetBean getRequest() {
		return request;
	}
	public void setRequest(PlansPlansmsonnetBean request) {
