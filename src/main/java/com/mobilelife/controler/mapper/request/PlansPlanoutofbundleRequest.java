...
@ApiModel("filters")
public class PlansPlanoutofbundleRequest {
    @XmlAttribute
    ...
    @XmlElement
	private PlansPlanoutofbundleBean request;
	...
	public PlansPlanoutofbundleBean getRequest() {
		return request;
	}
	public void setRequest(PlansPlanoutofbundleBean request) {
